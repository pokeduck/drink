...
const fetchList = async () => {
  ...
  try {
    ...
    const res = await api.get<ApiResponse<PaginationList>>('/admin/drink-items', { params })
...
const handleSubmit = async () => {
  ...
  try {
    if (editingId.value) {
      await api.put(`/admin/drink-items/${editingId.value}`, form)
      ElMessage.success('更新成功')
    } else {
      await api.post('/admin/drink-items', form)
...
const handleDelete = async (row: DrinkItem) => {
  try {
    ...
    await api.delete(`/admin/drink-items/${row.id}`)
...
const handleBatchDelete = async () => {
  ...
  try {
    ...
    await api.delete('/admin/drink-items/batch', {
...
const handleSaveSort = async () => {
  ...
  try {
    ...
    await api.put('/admin/drink-items/sort', { items })
