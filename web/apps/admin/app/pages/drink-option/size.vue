...
const fetchList = async () => {
  ...
  try {
    ...
    const res = await api.get<ApiResponse<PaginationList>>('/admin/sizes', { params })
...
const handleSubmit = async () => {
  ...
  try {
    if (editingId.value) {
      await api.put(`/admin/sizes/${editingId.value}`, form)
      ElMessage.success('更新成功')
    } else {
      await api.post('/admin/sizes', form)
...
const handleDelete = async (row: Size) => {
  try {
    ...
    await api.delete(`/admin/sizes/${row.id}`)
...
const handleBatchDelete = async () => {
  ...
  try {
    ...
    await api.delete('/admin/sizes/batch', {
...
const handleSaveSort = async () => {
  ...
  try {
    ...
    await api.put('/admin/sizes/sort', { items })
