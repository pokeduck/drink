...
<template>
  <div>
    ...
    <el-card shadow="never" v-loading="loading">
      <template #header>通用品名列表</template>
      <!-- 工具列 -->
      <div class="toolbar">
        ...
        <div class="toolbar-right">
          ...
          <el-button v-if="can(MENU.DrinkItem, 'create')" type="primary" icon="Plus" @click="router.push('/drink-option/item/create')">
            新增品名
          </el-button>
        </div>
      </div>
      ...
      >
        ...
        <el-table-column label="排序" width="150">
          <template #default="{ row }">
            <el-input-number v-if="can(MENU.DrinkItem, 'update')" v-model="row.sort" :min="0" :precision="0" style="width: 120px" />
        ...
        <el-table-column label="操作" width="160" fixed="right">
          <template #default="{ row }">
            <el-button v-if="can(MENU.DrinkItem, 'update')" size="small" @click="router.push(`/drink-option/item/${row.id}/edit`)">編輯</el-button>
