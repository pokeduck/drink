...
const fetchList = async () => {
  ...
  try {
    ...
    const res = await api.get<ApiResponse<PaginationList>>('/admin/sugars', { params })
...
const handleSelectionChange = (rows: Sugar[]) => {
...
const handleSubmit = async () => {
  ...
  try {
    if (editingId.value) {
      await api.put(`/admin/sugars/${editingId.value}`, form)
      ElMessage.success('更新成功')
    } else {
      await api.post('/admin/sugars', form)
...
const handleDelete = async (row: Sugar) => {
  try {
    ...
    await api.delete(`/admin/sugars/${row.id}`)
...
const handleBatchDelete = async () => {
  ...
  try {
    ...
    await api.delete('/admin/sugars/batch', {
...
const handleSaveSort = async () => {
  ...
  try {
    ...
    await api.put('/admin/sugars/sort', { items })
