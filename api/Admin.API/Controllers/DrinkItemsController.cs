...
public class DrinkItemsController : BaseController
{
  ...
  [ProducesResponseType(typeof(ApiResponse<PaginationList<DrinkItemListResponse>>), 200)]
  ...
  [HttpPut("{id}")]
  [RequireRole(MenuConstants.DrinkItem, CrudAction.Update)]
  [ProducesResponseType(typeof(ApiResponse<DrinkItemDetailResponse>), 200)]
  [ProducesResponseType(typeof(ApiResponse), 404)]
  [ProducesResponseType(typeof(ApiResponse), 409)]
  ...
  [HttpDelete("{id}")]
  [RequireRole(MenuConstants.DrinkItem, CrudAction.Delete)]
