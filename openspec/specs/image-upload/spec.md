...
定義圖片上傳服務的契約：副檔名與 magic bytes 雙重驗證、SkiaSharp 影像處理（去 EXIF、長邊縮圖、統一輸出 WebP quality 85）、SHA-256 content-addressed 路徑與去重、CDN-friendly 靜態檔回應、API Key 鑑權與 Admin/User API 的上傳代理流程。
